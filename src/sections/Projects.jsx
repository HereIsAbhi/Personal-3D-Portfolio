// import { div, exp } from "three/webgpu"
...
const Projects = () => {
    ...
    const handleNavigation = (direction) => {
        if(direction === 'next'){
            if(activeIndex === myProjects.length - 1){
                setActiveIndex(0);
            }else{
            ...
            if(activeIndex === 0){
                setActiveIndex(myProjects.length - 1);
            }else{
                setActiveIndex(activeIndex - 1);
            }
        }
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-5">
                        ...
                        <div className="flex items-center gap-3">
                            {currentProject.tags.map((tag, index) => (
                                <div key={index} className="tech-logo"><img src={tag.path} alt="" /></div>
                            ))}
                        </div>
